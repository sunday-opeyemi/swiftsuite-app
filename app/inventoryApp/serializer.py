...
class InventoryModelUpdateSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		exclude = ('id', 'user', 'last_updated', 'market_item_id', 'map_status', 'date_created', 'active', 'vendor_name', 'market_name', 'ends_status', 'market_item_url', 'vendor_identifier', 'manual_map')
