        ...
        if user.marketplace_name == "Ebay":
            ...
            for item in all_ebay_items:                         
                try:
                    ...
                    InventoryModel.objects.filter(user_id=user.user_id, id=existing_item.id).update(market_item_url=item.get("market_item_url"), market_logos="https://i.postimg.cc/3xZSgy9Z/ebay.png")
            ...
            try:
                for item in all_woocommercer_items:
                    ...
                    InventoryModel.objects.filter(user_id=user.user_id, id=existing_item.id).update(market_item_url=item.get("permalink"), market_logos="https://i.postimg.cc/Wbfbs7QB/woocommerce.png")
            except Exception as e:
                try:
